...
[Linux](http://lib.csdn.net/base/linux) 的软件安装目录是也是有讲究的，理解这一点，在对系统管理是有益的
...
http://blog.csdn[.NET](http://lib.csdn.net/base/dotnet)/secondjanuary/article/details/8972453
