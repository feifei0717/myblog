...
> 详细的规则配置请参考[分库分表](http://shardingjdbc.io/1.x/docs/02-guide/sharding)
...
> 详细的规则配置请参考[配置手册](http://shardingjdbc.io/1.x/docs/02-guide/configuration)



http://shardingjdbc.io/1.x/docs/01-start/quick-start/