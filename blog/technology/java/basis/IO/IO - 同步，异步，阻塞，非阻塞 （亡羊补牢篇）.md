...
本文讨论的背景是[Linux](http://lib.csdn.net/base/linux)环境下的network IO。
...
**blocking IO** 
在[linux](http://lib.csdn.net/base/linux)中，默认情况下所有的socket都是blocking，一个典型的读操作流程大概是这样：

![img](http://hi.csdn.net/attachment/201007/31/0_1280550787I2K8.gif)
