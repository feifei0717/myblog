...
![img](./image-201712221647/lock.png)
图1 通过加锁的方式实现线程安全
...
![img](./image-201712221647/cas.png)
图2 通过原子变量CAS实现线程安全
...
![img](./image-201712221647/computer.png)
图3 计算机CPU与缓存示意图
...
![img](./image-201712221647/falseSharing.png)
...
![img](./image-201712221647/singleWriter.png)
图5 单个生产者生产过程示意图
...
![img](./image-201712221647/multWriterReader.png)
...
![img](./image-201712221647/multWriterWrite.png)
...
![img](./image-201712221647/Unicast.png)
![img](./image-201712221647/ThreeStepPipeline.png)
![img](./image-201712221647/Sequencer.png)
![img](./image-201712221647/Multicast.png)
![img](./image-201712221647/Diamond.png)
...
![img](./image-201712221647/log4j2.png)
图8 Log4j 2各个模式性能比较
